      ...
      {open && (
        <div className="absolute z-50 top-full left-0 mt-1 bg-card border rounded-md shadow-md min-w-[100px] py-1">
          ...
          <button
            ...
            className={`w-full text-left px-2.5 py-1.5 text-xs hover:bg-muted ${
              value ? "text-emerald-600 font-medium" : "text-foreground"
            }`}
          >
            거래 완료
          </button>
          ...
          {type === "companion" && (
            <div className="space-y-3 pb-6 border-b">
              ...
              <p className="text-xs text-muted-foreground">
                달력에서 시작일과 종료일을 연속으로 클릭해 범위를 지정해 주세요.
              </p>
            </div>
          )}
          ...
          <div className="space-y-3 pt-4">
            ...
            >
              ...
              <p className="text-sm font-medium text-foreground">
                <span className="text-emerald-600 underline underline-offset-4 mr-1">
                  Click to upload
                </span>
                or drag and drop
              </p>
