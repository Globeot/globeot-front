              ...
              <>
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <span
                      className={`${stageBadgeClassMap[stage]} mt-1 inline-block`}
                    >
                      {stageLabelMap[stage]}
                    </span>
                  </div>
                  ...
                  {posts.length === 0 ? (
                    ...
                    posts.map((post) => (
                      <div
                        ...
                        onClick={() =>
                          router.push(`/community/${post.articleId}`)
                        }
                      >
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {post.type === "SALE" && post.articleStatus && (
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          <span
                            ...
                            onClick={() =>
                              router.push(`/community/${comment.articleId}`)
                            }
                          >
